...
<!---
# Access Full Paper
[![arXiv](https://img.shields.io/badge/arXiv-2212.02007-b31b1b.svg?style=flat-square)](https://arxiv.org/abs/2212.02007)
[![ResearchGate](https://img.shields.io/badge/ResearchGate-Paper-00CCBB.svg?style=flat-square)](https://www.researchgate.net/publication/366026509_Mixed_Cloud_Control_Testbed_Validating_Vehicle-Road-Cloud_Integration_via_Mixed_Digital_Twin)
...
2. Cai M, Xu Q, Yang C, et al. Experimental Validation of Multi-Lane Formation Control for Connected and Automated Vehicles[C]//2023 IEEE International Conference on Unmanned Systems (ICUS). IEEE, 2023: 1267-1273. <a href="https://arxiv.org/abs/2112.00312" target="_blank">[paper link]</a>
3. Dong J, Xu Q, Wang J, et al. Mixed cloud control testbed: Validating vehicle-road-cloud integration via mixed digital twin[J]. IEEE Transactions on Intelligent Vehicles, 2023. <a href="https://arxiv.org/abs/2212.02007" target="_blank">[paper link]</a>
4. Wang J, Zheng Y, Dong J, et al. Implementation and experimental validation of data-driven predictive control for dissipating stop-and-go waves in mixed traffic[J]. IEEE Internet of Things Journal, 2023. <a href="https://ieeexplore.ieee.org/document/10210648" target="_blank">[paper link]</a>
5. Li S, Chen C, Zheng H, et al. Mixed Platoon Control Under Noise and Attacks: Robust Data-Driven Predictive Control and Human-in-the-Loop Validation[J]. IEEE Transactions on Intelligent Transportation Systems, 2025. <a href="https://arxiv.org/abs/2411.13924" target="_blank">[paper link]</a>
6. Li S, Zhou J, Wang J, et al. Robust explicit data-driven predictive control for mixed vehicle platoons[J]. IEEE Internet of Things Journal, 2025. <a href="https://ieeexplore.ieee.org/abstract/document/11095288" target="_blank">[paper link]</a>
## Citing MCCT
